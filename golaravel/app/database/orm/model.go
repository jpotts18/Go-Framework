...
func (qb *QueryBuilder) Get() (*sql.Rows, error) {
	...
	return qb.conn.db.Query(query, qb.bindings...)
}

func (qb *QueryBuilder) First() *sql.Row {
	qb.limit = 1
	query := qb.buildSelectQuery()
	return qb.conn.db.QueryRow(query, qb.bindings...)
}
...
func (qb *QueryBuilder) Count() (int64, error) {
	...
	var count int64
	err := qb.conn.db.QueryRow(query, qb.bindings...).Scan(&count)
	return count, err
}
...
func (qb *QueryBuilder) Insert(data map[string]interface{}) (sql.Result, error) {
	...
	return qb.conn.db.Exec(query, values...)
}
...
func (qb *QueryBuilder) Delete() (sql.Result, error) {
	...
	return qb.conn.db.Exec(query, qb.bindings...)
}
